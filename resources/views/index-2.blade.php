                    ...
                    <div class="col-auto ms-auto">
                        ...
                        <div class="d-inline-flex align-items-center">
                            <div class="top-text">
                                ...
                                <span class="fw-7 txt-blue">254 Street Avenue, LA US</span>
                            </div>
                            <div class="top-text">
                                <small class="txt-ligt-gray">Emaii Us</small>
                                <span class="fw-6 txt-blue"><a href="#" class="txt-blue">support@logzee.com</a></span>
                            </div>
                            <div class="top-text">
                                <small class="txt-ligt-gray">Phone Number</small>
                                <span class="fw-7 txt-blue">+88 (0) 202 0000 001</span>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="icon-box-7">
                            <img src="assets/images/icon-box-six-1.jpg" alt="">
                            <h3 class="h3-xs txt-blue">Ground<br>Delivery</h3>
                            <a href="service-details.html" class="btn-arrow bg-navy-blue"><i
                                    class="icofont-swoosh-right"></i></a>
                        </div>
                        <p class="text-center">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
                            cubilia Curae.</p>
                    </div>
                    <!-- Icon Box 7 -->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="icon-box-7">
                            <img src="assets/images/icon-box-six-2.jpg" alt="">
                            <h3 class="h3-xs txt-blue">AIR<br>DELIVERY</h3>
                            <a href="service-details.html" class="btn-arrow bg-navy-blue"><i
                                    class="icofont-swoosh-right"></i></a>
                        </div>
                        <p class="text-center">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="icon-box-7">
                            <img src="assets/images/icon-box-six-3.jpg" alt="">
                            <h3 class="h3-xs txt-blue">Sea<br>Delivery</h3>
                            <a href="service-details.html" class="btn-arrow bg-navy-blue"><i
                                    class="icofont-swoosh-right"></i></a>
                        </div>
                        <p class="text-center">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="icon-box-7">
                            <img src="assets/images/icon-box-six-4.jpg" alt="">
                            <h3 class="h3-xs txt-blue">Packaging &<br>Storage</h3>
                            <a href="service-details.html" class="btn-arrow bg-navy-blue"><i
                                    class="icofont-swoosh-right"></i></a>
                        </div>
                        <p class="text-center">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="pricing-table bg-white">
                            ...
                            <a href="#" class="btn-theme bg-orange">Signup Now</a>
                        </div>
                    </div>
                    <!-- Pricing Table -->
                    ...
                    <!-- Pricing Table -->
                    <div class="col-md-4 col-sm-12">
                        <div class="pricing-table bg-white best-seller">
