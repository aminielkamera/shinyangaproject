...
<body>
    ...
    <header class="wow fadeInDown header-sixth">
        ...
        <nav class="header-fullpage navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="d-inline-flex request-btn order-lg-last">
                    ...
                    <a class="btn-theme icon-left bg-orange no-shadow align-self-center" href="#" role="button"
                ...
                <div class="collapse navbar-collapse nav-light" id="navbarCollapse">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner bg-image" data-background="assets/images/banner_slider_4.jpg"
                            data-text="How We Work<span>For Your Pickup</span>">
                            <div class="container">
                                <h6 data-swiper-parallax="100">From Pickup to Destination</h6>
                                <h2 data-swiper-parallax="200">We Are LogZee</h2>
                                <p data-swiper-parallax="300">We deliver your products on time with pure safety. Sed ut
                                    perspiciatis unde<br> omnis iste natus error sit voluptatem accusantium doloremque
                                    audantium.</p>
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner bg-image" data-background="assets/images/banner_slider_3.jpg"
                            data-text="Large Mass<span>Of Transportation</span>">
                            <div class="container">
                                <h6 data-swiper-parallax="100">From Pickup to Destination</h6>
                                <h2 data-swiper-parallax="200">We Are LogZee</h2>
                                <p data-swiper-parallax="300">We deliver your products on time with pure safety. Sed ut
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner bg-image" data-background="assets/images/banner_slider_2.jpg"
                            data-text="Always On<span>Time Delivery</span>">
                            <div class="container">
                                <h6 data-swiper-parallax="100">From Pickup to Destination</h6>
                                <h2 data-swiper-parallax="200">We Are LogZee</h2>
                                <p data-swiper-parallax="300">We deliver your products on time with pure safety. Sed ut
    ...
    <main id="body-content">
            ...
            <div class="container pos-rel">
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <p><img src="assets/images/years_img.png" alt="" class="mb-5"></p>
        ...
        <section class="bg-light-gray wide-tb-100 bg-wave">
            <div class="container pos-rel">
                <div class="row">
                    <div class="col-lg-5">
                        <img src="assets/images/about_img_2.jpg" class="bordered-img" alt="">
                    </div>

                    <div class="col-lg-7 ml-auto why-choose mt-5 mt-lg-0 wow fadeInRight" data-wow-duration="0"
                        data-wow-delay="0.6s">
                        <!-- Heading Main -->
                    ...
                    <div class="cbp-item design">
                        ...
                        <a href="images/portfolio/fullwidth/img-1.jpg" class="cbp-caption cbp-lightbox"
                            ...
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/fullwidth/img-1.jpg" alt="">
                            </div>
...
">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/fullwidth/img-2.jpg" alt="">
                            </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item illustration">
                        ...
                        <a href="images/portfolio/fullwidth/img-3.jpg" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum
">
                            <div class="cbp-caption-defaultWrap">
                    ...
                    <div class="cbp-item photography">
                        ...
                        <a href="images/portfolio/fullwidth/img-7.jpg" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum
">
                            <div class="cbp-caption-defaultWrap">
                    ...
                    <div class="cbp-item identity">
                        ...
                        <a href="images/portfolio/fullwidth/img-8.jpg" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum
">
                            <div class="cbp-caption-defaultWrap">
                    ...
                    <div class="cbp-item business">
                        ...
                        <a href="images/portfolio/fullwidth/img-9.jpg" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum
">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/fullwidth/img-9.jpg" alt="">
                            </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item photography">
                        ...
                        <a href="images/portfolio/fullwidth/img-10.jpg" class="cbp-caption cbp-lightbox"
                            data-title="Lorem ipsum">
                            <div class="cbp-caption-defaultWrap">
                    ...
                    <div class="cbp-item business">
                        ...
                        <a href="images/portfolio/fullwidth/img-11.jpg" class="cbp-caption cbp-lightbox"
                            data-title="Lorem ipsum">
                            <div class="cbp-caption-defaultWrap">
