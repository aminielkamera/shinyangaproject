...
<section class="wide-tb-80 bg-light-theme bg-fixed clients-bg-sustaina pos-rel  pos-rel">
    <div class='circle'></div>
    <div class="container pos-rel">
        <div class="row align-items-start">
            <div class="col-12 col-lg-8 wow fadeInUp mb-5" data-wow-duration="0" data-wow-delay="0s">
                <div class="icon-box-2">
                    <div class="media">
                        <div class="service-inner-content media-body">
                            ...
                            <p>Every day we approach sustainability performance as an opportunity
                                to build a positive legacy and deliver value throughout and beyond
                                the life of our mines. These societal outcomes are inextricably
                                linked to the way we manage our operations and invest in
                                sustainable, industry-leading practices at every level of
                                Magsam Gold.
                            </p>
                        </div>
                    </div>
...
<div class="row">
        ...
        <section class="wide-tb-80 bg-scroll bg-img-6 pos-rel callout-style-1">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12 mb-0 wow slideInUp" data-wow-duration="0" data-wow-delay="0.1s">
    ...
    <div class="col-md-4">
        <section class="wide-tb-80 bg-white">
            <div class="container">
                <div class="bg-light-theme text-center rounded">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <div class="col-md-4">
        <section class="wide-tb-80 bg-light-gray">
            <div class="container">
                <div class="bg-light-gray text-left rounded">
                    <div class="row">
                    <h3 class="h3-md fw-7">Sustainability</h3>
                            <div class="blog-list-categories">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="{{ Request::is('mining_processing') ? 'active' : '' }}"><a href="#">Health & Safety</a></li>
                                    <li class="{{ Request::is('sale_product') ? 'active' : '' }}"><a href="#">Environmental Management</a></li>
                                    <li class="{{ Request::is('rehabilitation') ? 'active' : '' }}"><a href="#">Social Performance</a></li>
                                </ul>
                            </div>
                    </div>
                </div>
