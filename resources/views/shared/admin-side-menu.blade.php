        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{url('admin-dashboard')}}" key="t-default">Sliders</a></li>
                    <li><a href="{{url('admin-home-about')}}" key="t-saas">About Us</a></li>
                    <li><a href="{{url('admin-home-process')}}" key="t-crypto">Process</a></li>
                    <li><a href="{{url('admin-home-sustanability')}}" key="t-crypto">Sustainability</a></li>
                    <li><a href="{{url('admin-home-our-team')}}" key="t-crypto">Our Team</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{url('admin-aboutUs-main-content')}}" key="t-horizontal">Main content</a></li>
                    <li><a href="{{url('admin-aboutUs-mission')}}" key="t-vertical">Mission</a></li>
                    <li><a href="{{url('admin-aboutUs-vission')}}" key="t-light-sidebar">Vission</a></li>
                </ul>
            </li>
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="bx bx-layout"></i>
                    <span key="t-layouts">Operations</span>
                </a>
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{url('admin-exploration-operation')}}" key="t-horizontal">Exploration</a></li>
                    <li><a href="{{url('admin_gold_mining_operation')}}" key="t-vertical">Gold Mining</a></li>
                    <li><a href="{{url('admin_processing_operation')}}" key="t-light-sidebar">Processing</a></li>
                    <li><a href="{{url('admin_rehabilitation')}}">Rehabilitation</a></li>
                    <li><a href="{{url('admin_export_gold')}}">Export of Gold</a></li>
                </ul>
            </li>
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="bx bx-layout"></i>
                    <span key="t-layouts">Sustainability</span>
                </a>
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{url('admin_responsible_mining')}}" key="t-horizontal">Responsible Mining</a></li>
                    <li><a href="{{url('admin_health_safety')}}" key="t-vertical">Health and Safety</a></li>
                    <li><a href="{{url('admin_environmental_management')}}" key="t-light-sidebar">Environmental Management</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{ url('form-elements')}}" key="t-form-elements">Form Elements</a></li>
                    <li><a href="{{ url('form-layouts')}}" key="t-form-layouts">Form Layouts</a></li>
                    <li><a href="{{ url('form-validation')}}" key="t-form-validation">Form Validation</a></li>
                    <li><a href="{{ url('form-advanced')}}" key="t-form-advanced">Form Advanced</a></li>
                    <li><a href="{{ url('form-editors')}}" key="t-form-editors">Form Editors</a></li>
                    <li><a href="{{ url('form-uploads')}}" key="t-form-upload">Form File Upload</a></li>
                    <li><a href="{{ url('form-xeditable')}}" key="t-form-xeditable">Form Xeditable</a></li>
                    <li><a href="{{ url('form-repeater')}}" key="t-form-repeater">Form Repeater</a></li>
                    <li><a href="{{ url('form-wizard')}}" key="t-form-wizard">Form Wizard</a></li>
                    <li><a href="{{ url('form-mask')}}" key="t-form-mask">Form Mask</a></li>
                </ul>
            </li>
