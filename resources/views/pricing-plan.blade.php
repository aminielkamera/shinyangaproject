            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="pricing-table">
                            ...
                            <a href="#" class="btn-theme bg-orange text-nowrap">Signup Now</a>
                        </div>
                    </div>
                    <!-- Pricing Table -->
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="pricing-table best-seller">
                            ...
                            <a href="#" class="btn-theme bg-navy-blue text-nowrap">Signup Now</a>
                        </div>
                    </div>
                    <!-- Pricing Table -->
                ...
                <div class="row text-center mt-5 pt-4">
                    <div class="col-md-10 col-lg-8 mx-auto">
                        <h3 class="h3-xl txt-blue">Still! <span class="lead">Troubles with Pricing?</span></h3>
                        ...
                        <a href="#" class="btn-theme bg-orange mt-2">Chat Support <i
                                class="icofont-rounded-right"></i></a>
                    </div>
                </div>
            </div>
