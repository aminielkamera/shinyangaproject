...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <form method="POST" action="{{ url('admin/home/sustanability')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                                ...
                                <div class="mb-4">
                                    <div class="form-group">
                                        <div class="file-loading">
                                            <input id="file-1" type="file" name="home_sustanabilityImages[]" multiple class="file" data-overwrite-initial="false" data-min-file-count="2" data-theme="fas">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <div class="form-group">
                                        <div class="file-loading">
                                            <input id="file-2" type="file" name="home_sustanabilityImages[]" multiple class="file" data-overwrite-initial="false" data-min-file-count="2" data-theme="fas">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <div class="form-group">
                                        <div class="file-loading">
                                            <input id="file-3" type="file" name="home_sustanabilityImages[]" multiple class="file" data-overwrite-initial="false" data-min-file-count="2" data-theme="fas">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <div class="form-group">
                                        <div class="file-loading">
                                            <input id="file-4" type="file" name="home_sustanabilityImages[]" multiple class="file" data-overwrite-initial="false" data-min-file-count="2" data-theme="fas">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
