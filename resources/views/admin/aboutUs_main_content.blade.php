...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <form method="POST" action="{{action('AdminController@submitAboutUsMainContent')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <textarea class="form-control form-control-sm" type="text" placeholder="Short Texts" name="text"></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <input class="form-control form-control-sm" type="text" placeholder="Video Link" name="videoLink">
                                    </div>
                                    <div>
