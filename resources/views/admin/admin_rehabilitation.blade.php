...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Rehabilitation operation  images upload and descriptions</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Operations</a></li>
                                <li class="breadcrumb-item active">Rehabilitation Images Upload</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
            <form method="POST" action="{{action('AdminController@submitRehabilitationOp')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                                    ...
                                    <div class="mb-4">
                                        <div class="upload-box">
                                            <div class="document_one " id="proof-of-payment">
                                                <div class="dz-message text-wrap" data-dz-message="">
                                                    <span class="dz-message-text">Drag and drop file</span>
                                                    <span><small>Sub Images here</small></span>
                                                    <span class="dz-message-or">or</span>
                                                    <!-- <input class="fileElem form-control form-control-lg" name="proof" style="display:none" accept="image/pdf*" id="formFileLg" type="file" /> -->
                                                    <input type="file" class="fileElem1" id="fileElem1" name="image_Name[]" accept="image/pdf*" style="display:none">
