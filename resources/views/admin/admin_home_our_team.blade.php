...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Our team images upload and descriptions</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                <li class="breadcrumb-item active">Our Team Images Upload</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
            <form method="POST" action="{{action('AdminController@submitHomeOurTeamImages')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div>
                                        ...
                                        <div class="upload-box">
                                            <div class="document_one " id="proof-of-payment">
                                                <div class="dz-message text-wrap" data-dz-message="">
                                                    ...
                                                    <input type="file" class="fileElem" id="fileElem" name="home_ourTeamImages[]" multiple accept="image/*" style="display:none">
                                    ...
                                    <div>
                                        <input class="form-control form-control-lg" type="text" placeholder="Position" name="position[]">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="upload-box">
                                            <div class="document_one " id="proof-of-payment">
                                                <div class="dz-message text-wrap" data-dz-message="">
                                                    ...
                                                    <span class="dz-message-or">or</span>
                                                    <!-- <input class="fileElem form-control form-control-lg" name="proof" style="display:none" multiple accept="image/*" id="formFileLg" type="file" /> -->
                                                    <input type="file" class="fileElem1" id="fileElem1" name="home_ourTeamImages[]" multiple accept="image/*" style="display:none">
                                                    <!-- <i class="display-4 text-muted bx bxs-cloud-upload"></i> -->
                                        ...
                                        <div class="upload-box">
                                            <div class="document_one " id="proof-of-payment">
                                                <div class="dz-message text-wrap" data-dz-message="">
                                                    ...
                                                    <span class="dz-message-or">or</span>
                                                    <!-- <input class="fileElem form-control form-control-lg" name="proof" style="display:none" multiple accept="image/*" id="formFileLg" type="file" /> -->
                                                    <input type="file" class="fileElem2" id="fileElem2" name="home_ourTeamImages[]" multiple accept="image/*" style="display:none">
                                                    <!-- <i class="display-4 text-muted bx bxs-cloud-upload"></i> -->
                                        ...
                                        <div class="upload-box">
                                            <div class="document_one " id="proof-of-payment">
                                                <div class="dz-message text-wrap" data-dz-message="">
                                                    ...
                                                    <span class="dz-message-or">or</span>
                                                    <!-- <input class="fileElem form-control form-control-lg" name="proof" style="display:none" multiple accept="image/*" id="formFileLg" type="file" /> -->
                                                    <input type="file" class="fileElem3" id="fileElem3" name="home_ourTeamImages[]" multiple accept="image/*" style="display:none">
                                                    <!-- <i class="display-4 text-muted bx bxs-cloud-upload"></i> -->
                                                    <a type="button" class="fileSelect3 white btn btn-primary" id="fileSelect3">Select</a>
                                                    <div class="fileList3 center" id="fileList3">
...
<script>
    const fileSelect3 = document.querySelector('.fileSelect3'),
        fileElem3 = document.querySelector('.fileElem3'),
        fileList3 = document.querySelector('.fileList3');
    ...
    fileElem3.addEventListener("change", handleFiles, false);

    function handleFiles() {
        fileList3.innerHTML = "";
        const list = document.createElement("ul");
        fileList3.appendChild(list);
        for (let i = 0; i < this.files.length; i++) {
            const li = document.createElement("li");
            list.appendChild(li);
