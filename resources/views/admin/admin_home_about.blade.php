...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">About us images upload and description</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                <li class="breadcrumb-item active">About Us Image Upload</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
            <form method="POST" action="{{ url('admin/home/about')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="mb-4">
                                    <div class="form-group">
                                        <div class="file-loading">
                                            <input id="file-1" type="file" name="home_aboutImage" multiple class="file" data-overwrite-initial="false" data-min-file-count="2" data-theme="fas">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <textarea class="form-control form-control-lg" type="text" placeholder="Descriptions" name="home_aboutDescriptions"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
