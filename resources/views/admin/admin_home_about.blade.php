...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <form method="POST" action="{{action('AdminController@submitHomeAboutImage')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                        ...
                                        <div class="upload-box">
                                            <div class="document_one " id="proof-of-payment">
                                                <div class="dz-message text-wrap" data-dz-message="">
                                                    ...
                                                    <input type="file" class="fileElem" id="fileElem" name="home_aboutImage[]" accept="image/pdf*" style="display:none">
