...
<body>
    ...
    <main id="body-content">
            ...
            <div class="container pos-rel">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8 mx-auto col-md-12">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam feugiat sodales mauris.
                            Proin quis elit vel ligula rutrum bibendum. Aenean et orci hendrerit, consectetur nulla eu,
                            viverra magna. In et ipsum.Fusce gravida quam non velit ornare bibendum. Etiam sit amet diam
                            arcu.</p>

                        <p>Nunc tristique tellus quam, id ultrices urna rhoncus non. Cras rhoncus interdum arcu eget
                            congue. Curabitur non justo velit. Proin vitae elit condimentum, tincidunt dui id, egestas
                            orci. Curabitur feugiat enim ullamcorper faucibus sodales. Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Aliquam feugiat sodales mauris. Proin quis elit vel ligula
                            rutrum bibendum. Aenean et orci hendrerit, consectetur nulla eu, viverra magna. In et ipsum.
                        </p>
                    </div>
        ...
        <!-- What Makes Us Special Start -->
        <section class="bg-light-gray wide-tb-100 why-choose">
            <div class="container pos-rel">
                <div class="row align-items-center">

                    <!-- Icon Box 2 -->
                    <div class="col-12 col-lg-7 col-md-6">
                        <img src="assets/images/blog_single.jpg" alt="">
                    </div>
                    <!-- Icon Box -->
                        ...
                        <div class="icon-box-2">
                            <div class="media">
                                <div class="service-inner-content media-body">
                                    <h4 class="h4-md">Project Details </h4>
                                    ...
                                    <p><strong>Live Demo:</strong> <a href="#"
                                            class="link-oragne">www.wichalewarehouse.com <i
                                                class="icofont-external-link"></i></a></p>
                                    <p><strong>Tags:</strong> <a href="#" class="link-oragne">Outstanding</a>, <a href="#" class="link-oragne">Lifestyle</a> <a href="#" class="link-oragne">Travel</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Other Project Start -->
        <section class="wide-tb-100 why-choose">
            <div class="container">
                    ...
                    <div class="cbp-item">
                        ...
                        <a href="project-single.html">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/3col-9.jpg" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="cbp-item">
                        ...
                        <a href="project-single.html">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/3col-8.jpg" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="cbp-item">
                        ...
                        <a href="project-single.html">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/3col-7.jpg" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="cbp-item">
                        ...
                        <a href="project-single.html">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/3col-6.jpg" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="cbp-item">
                        ...
                        <a href="project-single.html">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/3col-5.jpg" alt="">
                            </div>
                        </a>
                    </div>
                </div>
