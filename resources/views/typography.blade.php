...
<body>
    ...
    <main id="body-content">
        ...
        <section class="wide-tb-100 pb-0">
            <div class="container pos-rel">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Headings</h3>

                        <div class="row">
                            <!-- Heading H1 -->
                            <div class="col-sm-6">
                                <h1 class="txt-orange">Heading H1</h1>
                                <p>Mauris at ultricies eros. Morbi vel dui nec arcu suscipit euismod. Phasellus
                                    pellentesque lectus eget quam ullamcorper consectetur.</p>
                            </div>
                            <!-- Heading H1 -->

                            <!-- Heading H2 -->
                            <div class="col-sm-6">
                                <h2 class="txt-orange">Heading H2</h2>
                                <p>Mauris at ultricies eros. Morbi vel dui nec arcu suscipit euismod. Phasellus
                                    pellentesque lectus eget quam ullamcorper consectetur.</p>
                            </div>
                            <!-- Heading H2 -->
                            ...
                            <!-- Heading H3 -->
                            <div class="col-sm-6">
                                <h3 class="txt-blue">Heading H3</h3>
                                <p>Mauris at ultricies eros. Morbi vel dui nec arcu suscipit euismod. Phasellus
                                    pellentesque lectus eget quam ullamcorper consectetur.</p>
                            </div>
                            <!-- Heading H2 -->
                    ...
                    <div class="col-md-6">
                        ...
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Others Heading</h3>
                        <div class="page-header">
                            <h1 class="txt-orange">Morbi vel dui nec arcu suscipit euismod. <small
                                    class="txt-ligt-gray">Subtext for header</small></h1>
                        </div>
                        <p class="lead">Mauris at ultricies eros. Morbi vel dui nec arcu suscipit euismod. Phasellus
                            pellentesque lectus eget quam ullamcorper consectetur. Suspendisse sed turpis non nulla
                            auctor posuere. Nulla ut libero tortor. Nam tortor metus, accumsan in tincidunt a, aliquam
                            vitae diam. </p>
                        <small>Mauris at ultricies eros. Morbi vel dui nec arcu suscipit euismod. Phasellus pellentesque
                            lectus eget quam ullamcorper consectetur. Suspendisse sed turpis non nulla auctor posuere.
                            Nulla ut libero tortor. Nam tortor metus, accumsan in tincidunt a, aliquam vitae diam.
                        </small>
                    </div>
        ...
        <!-- Default Grid Start -->
        <section class="wide-tb-100 pb-5 why-choose">
            <div class="container pos-rel">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Default Grid System</h3>
                        <div class="bs-docs-grid">
                            ...
                            <div class="show-grid row">
                                <div class="col-md-3"><span>.col-md-3</span></div>
                                <div class="col-md-3"><span>.col-md-3</span></div>
                                <div class="col-md-3"><span>.col-md-3</span></div>
                                <div class="col-md-3"><span>.col-md-3</span></div>
                            </div>
                            ...
                            <div class="show-grid row">
                                <div class="col-md-9"><span>.col-md-9</span></div>
                                <div class="col-md-3"><span>.col-md-3</span></div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="wide-tb-100 pb-0">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Text Aligments</h3>
                        ...
                        <p class="text-justify">
                            ...
                            <br>
                            Consequat te olim letalis premo ad hos olim odio olim indoles ut venio iusto. Euismod,
                            sagaciter diam neque antehabeo blandit, jumentum transverbero luptatum. Lenis vel diam
                            praemitto molior facilisi facilisi suscipere abico, ludus, at.
                        </p>

                    </div>
                    <div class="col-md-4">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Emphasis Classes</h3>
                    ...
                    <div class="col-md-4">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Addresses</h3>
                        <!--Addresses-->
                        <address>
                        ...
                        <!--Abbreviation-->
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Abbreviation</h3>
                        <p>An abbreviation of the word attribute is <abbr title="attribute">attr</abbr> <br><abbr
                                title="HyperText Markup Language" class="initialism">HTML</abbr> is the best thing since
                            sliced bread.</p>
                        <!--Abbreviation-->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <blockquote class="blockquote-2">
                            ...
                            <footer><cite title="Source Title">Steven Snell Google</cite></footer>
                        </blockquote>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="wide-tb-100 pb-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Dropcaps</h3>
                    </div>
                    <div class="col-sm-4">
                        <p><span class="dropcap">D</span>Consequat te olim letalis premo ad hos olim odio olim indoles
                            ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit, jumentum transverbero
                            luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere abico, ludus, at.</p>
                    </div>

                    <div class="col-sm-4">
                        <p><span class="dropcap2 bg-orange">D</span>Consequat te olim letalis premo ad hos olim odio
                            olim indoles ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit, jumentum
                            transverbero luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere abico,
                            ludus, at.</p>
                    </div>

                    <div class="col-sm-4">
                        <p><span class="dropcap2 rounded-circle bg-navy-blue">D</span>Consequat te olim letalis premo ad
                            hos olim odio olim indoles ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit,
                            jumentum transverbero luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere
                            abico, ludus, at.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-sm-12 col-lg-3 col-md-6">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Bullet Style</h3>
                    ...
                    <!-- Bullet Style Light -->
                    <div class="col-sm-12 col-lg-3 col-md-6">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Bullet Style Light</h3>
                        <ul class="list-unstyled icons-listing theme-light mb-0">
                            <li><i class="icofont-check"></i>Deliver Environmentally Responsible Client Services</li>
                            <li><i class="icofont-check"></i>Be an Active Community Partner</li>
                            <li><i class="icofont-check"></i>Drive Continuous Improvement</li>
                            <li><i class="icofont-check"></i>Clearance and compliance service</li>
                    ...
                    <!-- Bullet Style Dark -->
                    <div class="col-sm-12 col-lg-3 col-md-6">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Bullet Style Dark</h3>
                    ...
                    <div class="col-sm-12 col-lg-3 col-md-6">
                        <h3 class="h3-sm fw-6 txt-blue mb-4">Different Bullet Style</h3>
                        <ul class="list-unstyled icons-listing theme-dark mb-0">
                            <li><i class="icofont-check"></i>Deliver Environmentally Responsible Client Services</li>
                            <li><i class="icofont-dotted-right"></i>Be an Active Community Partner</li>
                            <li><i class="icofont-double-right"></i>Drive Continuous Improvement</li>
                            <li><i class="icofont-thin-right"></i>Clearance and compliance service</li>
                        </ul>
                    </div>
                    <!-- Different Bullet Style -->
                </div>
