                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="text-left">
                                    ...
                                    <h4 class="h4-md mb-3 fw-7 txt-blue">Logistics Should Brace for Changes in Cargo
                                    </h4>
                                ...
                                <div class="wide-tb-70">
                                    <div class="author-box rounded">
                                        <div class="media">
                                            <div class="thumb">
                                                <img src="assets/images/team_1.jpg" alt="" class="rounded-circle thumb">
                                            </div>
                                            <div class="service-inner-content media-body">
                                                <h4 class="h4-xs txt-blue">Author: Brad Thomas</h4>
                                                Explain to you how all this mistaken idea of hovered link and praising
                                ...
                                <div class="commnets-reply">
                                    ...
                                    <div class="media pb-5">
                                        <div class="thumb">
                                            <img class="rounded-circle" src="assets/images/team_2.jpg" alt="">
                                        </div>
                                        
                                        <div class="media-body">
                                            <div class="border-style d-md-flex justify-content-between">
                                                <h4 class="h4-xs txt-orange">Anonymous</h4>
                                                <small class="txt-blue">September 11, 2018 at 7:33 am</small>
                                            </div>
                                            <p>Hi, this is a comment.</p>
                                            <p>To delete a comment, just log in and view the post's comments. There you
                                                will have the option to edit or delete them.</p>
                                            <p><a href="#" class="btn-theme bg-navy-blue mt-3">Reply <i
                                                        class="icofont-ui-reply"></i></a></p>
                                        </div>
                                    </div>
                                    <div class="media pb-5">
                                        <div class="thumb">
                                            <img class="rounded-circle" src="assets/images/team_3.jpg" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="border-style d-md-flex justify-content-between">
                                            ...
                                            <div class="media mt-5">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="h4-xs txt-orange fw-7">Mr WordPress</h4>
                                    ...
                                    <div class="media pb-5">
                                        <div class="thumb">
                                            <img class="rounded-circle" src="assets/images/team/team-2.jpg" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="border-style d-md-flex justify-content-between">
                                                <h4 class="h4-xs txt-orange">Anonymous</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="blog-warp">
                                            ...
                                            <div class="meta-box"><a href="#">Business</a> <span>/</span> September 28,
                                                2018</div>
                                            <h4 class="h4-md mb-3"><a href="#">Freight Payment and Auditing Services</a>
                                            </h4>
                                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                                accusantium doloremque laudantiumg</p>
                                        </div>
                                    </div>
                                    <!-- Blog Items -->
