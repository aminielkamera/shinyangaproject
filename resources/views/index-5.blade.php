...
<body>
    ...
    <main id="body-content" style="overflow: initial;">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-duration="0" data-wow-delay="0.1s">
                        ...
                        <a href="service-details.html">
                            <div class="icon-box-4 h-100">
                                ...
                                <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis. Vivamus
                                    ac ultrices diam, vitae accumsan tellus.</p>
                            </div>
                        </a>
                        <!-- Icon Box -->
                    </div>
        ...
        <section class="bg-white wide-tb-100 bg-wave">
            <div class="container pos-rel">
                <div class="row">
                    ...
                    <!-- Heading Main -->
                    <div class="col-lg-8 ml-auto why-choose wow fadeInRight" data-wow-duration="0"
                        data-wow-delay="0.6s">
                        <div class="row">
                            <!-- Icon Box 2 -->
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="service-inner-content media-body">
                                            ...
                                            <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem
                                                quis. Vivamus ac ultrices diam, vitae accumsan tellus.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-9 mx-auto">
                        ...
                        <form class="form-inline wow fadeInUp" data-wow-duration="0" data-wow-delay="0.2">
                            ...
                            <button type="submit" class="btn btn-theme bg-white mb-2 ml-3 bordered">Check Now <i
        ...
        <!-- Twitter Feed -->
        <section class="twitter-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        <div class="twitter-feed d-flex align-items-center rounded-bottom">
                            <i class="icofont-twitter icon-feed txt-orange"></i>
                    ...
                    <div class="col-lg-6 col-sm-12 wow fadeInLeft" data-wow-duration="0" data-wow-delay="0.1s">
                        ...
                        <div class="contact-details standard row pos-rel d-inline-flex">
                            <div class="col">
                                ...
                                <div class="text-nowrap"><i class="icofont-email"></i> <a
                                        href="#">germany@logzee.com</a></div>
                            </div>
                            <div class="col">
                                <h4>Spain</h4>
                                <p><i class="icofont-phone"></i> +1 (408) 786 - 5117</p>
