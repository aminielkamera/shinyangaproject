...
!(function(t, e) {
    ...
    function vt(t, e) {
        ...
        return { width: bt(i.width / n), height: bt(i.height / s), top: bt(i.top / s), right: bt(i.right / n), bottom: bt(i.bottom / s), left: bt(i.left / n), x: bt(i.left / n), y: bt(i.top / s) };
    }
    ...
    var Rt = {
            ...
            fn: function(t) {
                ...
                null != e.modifiersData.popperOffsets &&
                    (e.styles.popper = Object.assign({}, e.styles.popper, Bt(Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l })))),
                    null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, Bt(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
            ...
            Qt(
                (function(t) {
                    var e = ut(t),
                        ...
                        r = 0,
                        a = 0;
                    return n && ((s = n.width), (o = n.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((r = n.offsetLeft), (a = n.offsetTop))), { width: s, height: o, x: r + Kt(t), y: a };
                })(t)
            ) :
            pt(e) ?
            (function(t) {
                ...
                for (
                    var s = i.mainAxis,
                        ...
                        v = [g].concat(b).reduce(function(t, i) {
                            return t.concat("auto" === _t(i) ? te(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m }) : i);
                        }, []),
                        y = e.rects.reference,
                        w = e.rects.popper,
                        E = new Map(),
    ...
    function le(t, e, i) {
        ...
        return (
            ...
            (("body" !== dt(e) || Xt(a)) && (c = (n = e) !== ut(n) && pt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : Vt(n)),
                pt(e) ? (((h = vt(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = Kt(a))), { x: l.left + c.scrollLeft - h.x, y: l.top + c.scrollTop - h.y, width: l.width, height: l.height }
        );
    }
    ...
    function de(t) {
        ...
        return function(t, e, i) {
            ...
            var s,
                r,
                a = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, ce, o), modifiersData: {}, elements: { reference: t, popper: e }, attributes: {}, styles: {} },
                l = [],
                c = !1,
                h = {
                    state: a,
                    setOptions: function(i) {
                        ...
                        d(), (a.options = Object.assign({}, o, a.options, s)), (a.scrollParents = { reference: ft(t) ? Yt(t) : t.contextElement ? Yt(t.contextElement) : [], popper: Yt(e) });
                        var r,
                            c,
                            u = (function(t) {
                                var e = (function(t) {
    ...
    class Be extends H {
        ...
        _initializeBackDrop() {
            return new xe({ className: "offcanvas-backdrop", isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
        }
        _initializeFocusTrap() {
            return new Ne({ trapElement: this._element });
        }
    ...
    class Ye extends H {
            ...
            this._queueCallback(
                    () => {
                        this._isWithActiveTrigger() ||
                            ("show" !== this._hoverState && t.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), P.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper());
                    },
                    this.tip,
                    e
                ),
        ...
        setElementContent(t, e) {
            if (null !== t)
                return s(e) ?
                    ...
                    void(this._config.html ? (this._config.sanitize && (e = Fe(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
        }
        getTitle() {
        ...
        _fixTitle() {
            ...
            (t || "string" !== e) &&
            (this._element.setAttribute("data-bs-original-title", t || ""), !t || this._element.getAttribute("aria-label") || this._element.textContent || this._element.setAttribute("aria-label", t),
    ...
    return B(ai), m(ai), { Alert: R, Button: W, Carousel: Z, Collapse: et, Dropdown: Oe, Modal: je, Offcanvas: Be, Popover: Je, ScrollSpy: ni, Tab: si, Toast: ai, Tooltip: Ye };
});
    ...
    (p.expr.pseudos.appeared = p.expr.createPseudo(function(e) {
        return function(e) {
            ...
            var t = s.scrollLeft(),
                ...
                n = i.left,
                o = i.top;
            return o + r.height() >= a && o - (r.data("appear-top-offset") || 0) <= a + s.height() && n + r.width() >= t && n - (r.data("appear-left-offset") || 0) <= t + s.width();
        };
    })),
    p.fn.extend({
            appear: function(e, r) {
                    ...
                    (this.on("click.validate", ":submit", function(b) {
                        ...
                        this.on("submit.validate", function(b) {
                            function d() {
                                var d, e;
                                return (
                                    c.submitButton && (c.settings.submitHandler || c.formSubmitted) && (d = a("<input type='hidden'/>").attr("name", c.submitButton.name).val(a(c.submitButton).val()).appendTo(c.currentForm)), !(c.settings.submitHandler && !c.settings.debug) || ((e = c.settings.submitHandler.call(c, c.currentForm, b)), d && d.remove(), void 0 !== e && e)
                                );
                            }
    ...
    a.instagramFeed = function(f) {
        function g(d) {
            ...
            if (((d = d[0].graphql.user || d[0].graphql.hashtag), "" != h.container)) {
                ...
                } else k = { profile_container: "", profile_image: "", profile_name: "", profile_biography: "", gallery_image: "", gallery_image_link: "" };
                h.display_profile &&
                    ((l += '<div class="instagram_profile"' + k.profile_container + ">"),
                        (l += '<img class="instagram_profile_image" src="' + d.profile_pic_url + '" alt="' + (j ? d.name + " tag pic" : d.username + " profile pic") + '"' + k.profile_image + (h.lazy_load ? ' loading="lazy"' : "") + " />"),
                        (l += j ?
                            '<p class="instagram_tag"' + k.profile_name + '><a href="https://www.instagram.com/explore/tags/' + h.tag + '" rel="noopener" target="_blank">#' + h.tag + "</a></p>" :
                            "<p class='instagram_username'" + k.profile_name + ">@" + d.full_name + " (<a href='https://www.instagram.com/" + h.username + "' rel='noopener' target='_blank'>@" + h.username + "</a>)</p>"), !j && h.display_biography && (l += "<p class='instagram_biography'" + k.profile_biography + ">" + d.biography + "</p>"),
                        (l += "</div>"));
                ...
                if (h.display_gallery)
                    if ("undefined" != typeof d.is_private && !0 === d.is_private) l += '<p class="instagram_private"><strong>This profile is private</strong></p>';
                        ...
                        for (var r = 0; r < x; r++) {
                            ...
                            (l += '<a href="' + u + '"' + (h.display_captions ? ' data-caption="' + v + '"' : "") + ' class="instagram-' + t + '" rel="noopener" target="_blank"' + k.gallery_image_link + ">"),
                            (l += "<img" + (h.lazy_load ? ' loading="lazy"' : "") + ' src="' + s + '" alt="' + v + '"' + k.gallery_image + " />"),
                            (l += "</a>");
                        }
                        l += "</div>";
                    }
                    ...
                    if (0 < w.length) {
                        ...
                        for (var r = 0; r < x; r++) {
                            var u = "https://www.instagram.com/p/" + w[r].node.shortcode,
                                v = b(c(w[r], d));
                            (l += '<a href="' + u + '"' + (h.display_captions ? ' data-caption="' + v + '"' : "") + ' rel="noopener" target="_blank"' + k.gallery_image_link + ">"),
                            (l += "<img" + (h.lazy_load ? ' loading="lazy"' : "") + ' src="' + w[r].node.thumbnail_src + '" alt="' + v + '"' + k.gallery_image + " />"),
                            (l += "</a>");
                        }
                        l += "</div>";
                    }
        ...
        if (("undefined" != typeof h.get_data && console.warn("Instagram Feed: options.get_data is deprecated, options.callback is always called if defined"), null == h.callback && "" == h.container))
...
"function" != typeof Object.create &&
    ...
    (function(u, d, f, t) {
        ...
        var l = u.fn.cubeportfolio.constructor,
            ...
            e = {
                ...
                updateSinglePage: function(t, e, n) {
                    var i,
                        o = this;
                    o.content.addClass("cbp-popup-content").removeClass("cbp-popup-content-basic"), !1 === n && o.content.removeClass("cbp-popup-content").addClass("cbp-popup-content-basic"),
        ...
        function n(t) {
            var e = this;
            !1 === (e.parent = t).options.lightboxShowCounter && (t.options.lightboxCounter = ""), !1 === t.options.singlePageShowCounter && (t.options.singlePageCounter = ""),
                t.registerEvent(
                    "initStartRead",
                    function() {
                        e.run();
                    ...
                    if ((i.isScrolling && a.emit("touchMoveOpposite", o), "undefined" == typeof startMoving && ((r.currentX === r.startX && r.currentY === r.startY) || (i.startMoving = !0)), i.isTouched))
                        ...
                        if (
                            (s.touchReleaseOnEdges && (g = 0),
                                ...
                                m && (o.preventedByNestedSwiper = !0), !a.allowSlideNext && "next" === a.swipeDirection && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !a.allowSlidePrev && "prev" === a.swipeDirection && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate),
                                s.threshold > 0)
                        ) {
                    ...
                    return (
                        l.extend(c, {
                            ...
                            touchEvents: (function() {
                                ...
                                return (
                                    s.navigator.pointerEnabled ? (t = ["pointerdown", "pointermove", "pointerup"]) : s.navigator.msPointerEnabled && (t = ["MSPointerDown", "MsPointerMove", "MsPointerUp"]), { start: p.touch || !c.params.simulateTouch ? e[0] : t[0], move: p.touch || !c.params.simulateTouch ? e[1] : t[1], end: p.touch || !c.params.simulateTouch ? e[2] : t[2] }
                                );
                            })(),
                            touchEventsData: {
                                isTouched: void 0,
