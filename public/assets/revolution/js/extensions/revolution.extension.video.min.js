            ...
            switch (((g = !0 === a.nextslideatend ? "" : g), (a.videotype = y), h)) {
                case "html5":
                    ...
                    "video" === f &&
                        ...
                        ("on" === a.autoplay || "true" === a.autoplay || !0 === a.autoplay ? (b = "muted playsinline autoplay") : (1 != a.videoinline && "true" !== a.videoinline && 1 !== a.videoinline) || (b += " playsinline"));
            ...
            if (((d = "loop" == d || "loopandnoslidestop" == d), w(o, r), t.attr("id", a), e && r.data("startvideonow", !0), 1 !== r.data("videolistenerexist")))
                switch (l.videotype) {
                    case "youtube":
                                    ...
                                    if (e.data == YT.PlayerState.PLAYING)
                                        ...
                                        a ||
                                            ...
                                            (1 === r.data("bgvideo") ?
                                                ...
                                                punchgs.TweenLite.to(r.find("iframe"), 0.1, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })), -1 != e.data &&
                                            3 != e.data &&
                                            ((o.videoplaying = !1),
                                                (o.tonpause = !1),
                                                V(r, o),
                        ...
                        break;
                    case "vimeo":
                        for (var i, u = t.attr("src"), p = {}, v = u, c = /([^&=]+)=([^&]*)/g;
                            (i = c.exec(v));) p[decodeURIComponent(i[1])] = decodeURIComponent(i[2]);
            ...
            null != p &&
                ...
                A(r, "ended", function() {
                    T(),
                        ...
                        V(o, d),
                        "audio" != t && d.c.trigger("starttimer"),
                        d.c.trigger("revolution.slide.onvideostop", b(r, "html5", o.data())), !0 === o.data("nextslideatend") &&
                        0 < r.currentTime &&
