    ...
    jQuery.extend(!0, A, {
        updateMarkup: function(e, t) {
            ...
            if (void 0 !== i.start && !i.frames_added && void 0 === i.frames) {
                ...
                jQuery.isNumeric(i.end) && jQuery.isNumeric(i.start) && jQuery.isNumeric(n.speed) && (i.end = parseInt(i.end, 0) - (parseInt(i.start, 0) + parseFloat(n.speed, 0))),
                    ...
                    i.transform_hover && a.push({ frame: "hover", to: i.transform_hover, style: i.style_hover, speed: o.speed, ease: o.anim.ease, splitdelay: i.elementdelay }),
                    (i.frames = a);
            }
            if (!i.frames_added) {
                if (((i.inframeindex = 0), (i.outframeindex = -1), (i.hoverframeindex = -1), void 0 !== i.frames))
                    for (var s = 0; s < i.frames.length; s++)
                        void 0 !== i.frames[s].sfx_effect && 0 <= i.frames[s].sfx_effect.indexOf("block") && (0 === s ? ((i.frames[s].from = "o:0"), (i.frames[s].to = "o:1")) : (i.frames[s].to = "o:0"), (i._sfx = "block")),
                        void 0 === i.frames[0].from && (i.frames[0].from = "o:inherit"),
                        0 === i.frames[0].delay && (i.frames[0].delay = 20),
                        "hover" === i.frames[s].frame ?
                        (i.hoverframeindex = s) :
                        ("frame_999" !== i.frames[s].frame && "frame_out" !== i.frames[s].frame && "last" !== i.frames[s].frame && "end" !== i.frames[s].frame) || (i.outframeindex = s),
        ...
        animcompleted: function(e, t) {
            ...
            null != a &&
                ...
                (1 == n || "true" == n || "on" == n || "1sttime" == n || r ?
                    ...
                    ("no1sttime" == n && (i.datasetautoplay = "on"), A.unToggleState(e.data("videotoggledby"))));
        },
        ...
        animateTheCaptions: function(e) {
            ...
            if (
                ...
                d.append(
                        '<div class="hginfo">Zoom:' + Math.round(100 * p.bw) + "% &nbsp;&nbsp;&nbsp; Device Level:" + p.curWinRange + "&nbsp;&nbsp;&nbsp; Grid Preset:" + p.gridwidth[p.curWinRange] + "x" + p.gridheight[p.curWinRange] + "</div>"
                    ),
            ...
            void 0 !== a &&
                ...
                jQuery.each(p.layers[a], function(e, t) {
                    ...
                    A.updateMarkup(this, p),
                        A.prepareSingleCaption({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r }),
                        (r && 0 !== o) || A.buildFullTimeLine({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r, regenerate: 0 === o }),
                ...
                jQuery.each(p.layers.static, function(e, t) {
                    ...
                    !0 !== a.hoveredstatus && !0 !== a.inhoveroutanimation ?
                        (A.updateMarkup(this, p),
                            A.prepareSingleCaption({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r }),
                            (r && 0 !== o) || !0 === a.veryfirstststic || (A.buildFullTimeLine({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r, regenerate: 0 === o }), (a.veryfirstststic = !0)),
                            n && "carousel" === p.sliderType && "on" === p.carousel.showLayersAllTime && A.animcompleted(i, p)) :
                        A.prepareSingleCaption({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r });
                });
                    ...
                    (void 0 !== a &&
                        jQuery.each(p.timelines[a].layers, function(e, t) {
                            ...
                            ("keep" == t.triggerstate && "on" === i.triggerstate ?
                                A.playAnimationFrame({ caption: t.layer, opt: p, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999" }) :
                                t.timeline.restart());
                        }),
                        ...
                        jQuery.each(p.timelines.staticlayers.layers, function(e, t) {
                            ...
                            !0 !== i.hoveredstatus &&
                                ...
                                (void 0 !== s &&
                                    d &&
                                    ("keep" == c ?
                                        (A.playAnimationFrame({ caption: t.layer, opt: p, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999" }), i.triggeredtimeline.time(s)) :
                                        !0 !== i.hoveredstatus && t.timeline.time(s)),
                                    "reset" === c && "hidden" === m && (t.timeline.time(0), (i.animdirection = "out")),
                                    a ?
                                    d ?
                                    g === t.lastslide && (t.timeline.play(o), (i.animdirection = "in")) :
                                    (l || "in" === i.animdirection || t.timeline.play(r),
                                        (("visible" == m && "keep" !== c) || ("keep" === c && !0 === d) || ("visible" == m && void 0 === d)) && (t.timeline.play(r + 0.01), (i.animdirection = "in"))) :
        ...
        prepareSingleCaption: function(e) {
            ...
            if (
                ("off" === (void 0 === i.visibility ? "oon" : N(i.visibility, a)[a.forcedWinRange] || N(i.visibility, a) || "ooon") || (i._gw < a.hideCaptionAtLimit && "on" == i.captionhidden) || i._gw < a.hideAllCaptionAtLimit ?
                ...
                (m = void 0 === m ? 0 : m),
                "off" !== i._responsive ?
                    ("grid" != i._ba && g ? (jQuery.isNumeric(l) ? d.css({ width: l + "px" }) : d.css({ width: l })) : jQuery.isNumeric(l) ? d.css({ width: l * a.bw + "px" }) : d.css({ width: l }),
                        "grid" != i._ba && u ? (jQuery.isNumeric(m) ? d.css({ height: m + "px" }) : d.css({ height: m })) : jQuery.isNumeric(m) ? d.css({ height: m * a.bh + "px" }) : d.css({ height: m })) :
                    d.css({ width: l, height: m }),
                    i._ingroup &&
                    "row" !== i._nctype &&
                    (void 0 !== l && !jQuery.isNumeric(l) && "string" === jQuery.type(l) && 0 < l.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], { minWidth: l }),
                        void 0 !== m && !jQuery.isNumeric(m) && "string" === jQuery.type(m) && 0 < m.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], { minHeight: m }));
            }
            ...
            if (t.hasClass("tp-videolayer") || t.hasClass("tp-audiolayer") || 0 < t.find("iframe").length || 0 < t.find(v).length) {
                ...
                ((0 == b && !y) || (1 != i.forcecover && !t.hasClass("fullscreenvideo") && !y)) && (d.width(l), d.height(m)),
            ...
            "on" == a.fullScreenAlignForce && ((z = a.ulw), (O = a.ulh)),
                "none" !== i._lig && null != i._lig && ((z = i._lig.width()), (O = i._lig.height()), (e.offsetx = 0), (e.offsety = 0)),
            ...
            if (!(t = r.timelines[n._slideid].layers[n._id]).generated || !0 === e.regenerate) {
                if (
                    ((i = t.timeline),
                        ...
                        o.svg && ((n.idlesvg = f(n.svg_idle, u())), punchgs.TweenLite.set(o.svg, n.idlesvg.anim)), -1 !== n.hoverframeindex && void 0 !== n.hoverframeindex && !a.hasClass("rs-hover-ready"))
                ) {
                ...
                for (var l = 0; l < n.frames.length; l++)
                    if (l !== n.hoverframeindex) {
                        ...
                        void 0 !== t.firstslide && "frame_0" === m && (i.addLabel("slide_" + t.firstslide + "_pause", 0), i.addPause("slide_" + t.firstslide + "_pause"), i.addLabel("slide_" + t.firstslide, "+=0.005")),
                            void 0 !== t.lastslide && "frame_999" === m && (i.addLabel("slide_" + t.lastslide + "_pause", "+=0.01"), i.addPause("slide_" + t.lastslide + "_pause"), i.addLabel("slide_" + t.lastslide, "+=0.005")),
                            jQuery.isNumeric(p) ? i.addLabel(m, "+=" + p) : (i.addLabel("pause_" + l, "+=0.01"), i.addPause("pause_" + l), i.addLabel(m, "+=0.01")),
                            (i = A.createFrameOnTimeline({ caption: e.caption, timeline: i, label: m, frameindex: l, opt: r }));
                    }
        ...
        createFrameOnTimeline: function(e) {
            var t = e.caption,
                ...
                u = !1;
            if (
                ((p = void 0 === p ? "forward" : p), -1 !== i.hoverframeindex && i.hoverframeindex == m && (m -= 1),
            ...
            var h,
                ...
                F(X(), i.frames[i.inframeindex].from, 0 == o.sdir, u, s.length - 1),
                b = void 0 !== i.frames[r].from ? F(_, i.frames[i.inframeindex].from, 1 == o.sdir, u, s.length - 1) : void 0,
                y = i.frames[r].splitdelay;
            if (
                (0 !== r || e.fromcurrentstate ? (v = H(i.frames[r].mask)) : (h = H(i.frames[r].mask)),
                    (_.anim.ease = void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease),
                    void 0 !== b &&
                    ((b.anim.ease = void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease),
            ...
            if (0 !== r || e.fromcurrentstate)
                if ("block" === i._sfx_out && r === i.outframeindex) n.add(d.content.staggerTo(s, 0.001, { autoAlpha: 0, delay: x }), a), n.add(d.content.staggerTo(s, _.speed / 1e3 / 2 - 0.001, { x: 0, delay: x }), a + "+=0.001");
                else if (u && void 0 !== L) {
                R = { to: P(_.anim) };
                for (var I in s) {
            ...
            else if ("block" === i._sfx_in) n.add(d.content.staggerFromTo(s, 0.05, { x: 0, y: 0, autoAlpha: 0 }, { x: 0, y: 0, autoAlpha: 1, delay: x }), a);
            else if (u && void 0 !== L) {
                ...
                for (var I in s) {
                    ...
                    (z.ease = C.ease),
                    void 0 !== i.frames[r].color && ((C.color = i.frames[r].color), (z.color = i.cssobj.styleProps.color)),
                        void 0 !== i.frames[r].bgcolor && ((C.backgroundColor = i.frames[r].bgcolor), (z.backgroundColor = i.cssobj.styleProps["background-color"])),
                        n.add(d.content.fromTo(s[L[I]], b.speed / 1e3, C, z, y * I), a);
                }
            } else
                void 0 !== i.frames[r].color && ((b.anim.color = i.frames[r].color), (_.anim.color = i.cssobj.styleProps.color)),
                void 0 !== i.frames[r].bgcolor && ((b.anim.backgroundColor = i.frames[r].bgcolor), (_.anim.backgroundColor = i.cssobj.styleProps["background-color"])),
            ...
            return (
                ...
                (0 === r && h && !1 !== h && !e.fromcurrentstate) || (0 === r && e.ignorefirstframe) ?
                (((v = new Object()).anim = new Object()),
                    ...
                    h &&
                    !1 !== h &&
                    ((h.anim.x = h.anim.x * o.bw || Y(h.anim.x, o, i.eow, i.eoh, i.calcy, i.calcx, "horizontal")),
            ...
            if (
                (void 0 !== e.frame ?
                    ...
                    ((t.outnow = new punchgs.TimelineLite()),
                        t.timeline.pause(), !0 === i.visibleelement && A.createFrameOnTimeline({ caption: e.caption, timeline: t.outnow, label: "outnow", frameindex: e.caption.data("outframeindex"), opt: e.opt, fromcurrentstate: !0 }).play()),
            ...
            a &&
                jQuery.each(a, function(e) {
                    ...
                    "carousel" === i.sliderType && "on" === i.carousel.showLayersAllTime ?
                        (clearTimeout(t.data("videoplaywait")), A.stopVideo && A.stopVideo(t, i)) :
                        (r(t), clearTimeout(t.data("videoplaywait")), A.endMoveCaption({ caption: t, opt: i, currentslide: n })),
    ...
    var O = function(e, t, i, a, n, r, o, s, d) {
            ...
            if (
                ((l.layer = o),
                    ...
                    "enterstage" === l.eventtype && ((a.animdirection = "in"), (a.visibleelement = !0), A.toggleState(a.layertoggledby)),
        ...
        Y = function(e, t, i, a, n, r, o) {
            return (!jQuery.isNumeric(e) && e.match(/%]/g) ?
                ((e = e.split("[")[1].split("]")[0]), "horizontal" == o ? (e = ((i + 2) * parseInt(e, 0)) / 100) : "vertical" == o && (e = ((a + 2) * parseInt(e, 0)) / 100)) :
                (e =
                    "top" ===
                    (e =
    ...
    var v = function(a, e) {
        ...
        V = function(e, t) {
            ...
            if (
                ("rekursive" == t && (i = e.closest(".tp-caption")) && e.css("fontSize") === i.css("fontSize") && e.css("fontWeight") === i.css("fontWeight") && e.css("lineHeight") === i.css("lineHeight") && (n = !0),
                    ...
                    (a.zIndex = n ? (void 0 === i.data("zIndex") ? i.css("zIndex") || "inherit" : i.data("zIndex")) : void 0 === e.data("zIndex") ? e.css("zIndex") || "inherit" : e.data("zIndex")), -1 !== jQuery.inArray(e.data("layertype"), ["video", "image", "audio"]) || e.is("img") ?
                    (a.lineHeight = 0) :
                    (a.lineHeight = n ? (void 0 === i.data("lineheight") ? parseInt(i.css("lineHeight"), 0) || 0 : i.data("lineheight")) : void 0 === e.data("lineheight") ? parseInt(e.css("lineHeight"), 0) || 0 : e.data("lineheight")),
                    (a.letterSpacing = n ?
                ...
                if (
                    ...
                    if (
                        ((g = void 0 === g ? 0 : g),
                            ...
                            punchgs.TweenLite.set(e, { maxWidth: c, maxHeight: p, minWidth: g, minHeight: u, whiteSpace: r.whiteSpace, textAlign: r.textAlign, overwrite: "auto" }),
        ...
        b = function(e, t) {
            ...
            r._cbgc_man &&
                ...
                (jQuery.isArray(r.cssobj.marginLeft) ?
                    (r.cssobj.marginLeft[t.curWinRange] * t.bw, (i = r.cssobj.marginTop[t.curWinRange] * t.bh), (a = r.cssobj.marginBottom[t.curWinRange] * t.bh), r.cssobj.marginRight[t.curWinRange], t.bw) :
                    (r.cssobj.marginLeft * t.bw, (i = r.cssobj.marginTop * t.bh), (a = r.cssobj.marginBottom * t.bh), r.cssobj.marginRight, t.bw),
        ...
        c = function(e, t) {
            ...
            if (e.hasClass("rs-pendulum") && null == i._loop_timeline) {
                ...
                (a *= t),
                (n *= t),
                i._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", rotation: a, transformOrigin: o }, { rotation: n, ease: s })),
                    i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
                            e,
                            r, { force3D: "auto", rotation: n, transformOrigin: o }, {
                                rotation: a,
                                ease: s,
                                onComplete: function() {
            ...
            if (e.hasClass("rs-rotate") && null == i._loop_timeline) {
                ...
                i._loop_timeline.append(
                    new punchgs.TweenLite.fromTo(
                        e,
                        r, { force3D: "auto", rotation: a, transformOrigin: o }, {
                            rotation: n,
                            ease: s,
                            onComplete: function() {
                                i._loop_timeline.restart();
            ...
            if (e.hasClass("rs-slideloop") && null == i._loop_timeline) {
                ...
                (m *= t),
                (c *= t),
                i._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", x: d, y: l }, { x: m, y: c, ease: s })),
                    i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
                            e,
                            r, { force3D: "auto", x: m, y: c }, {
                                x: d,
                                y: l,
                                onComplete: function() {
                                    i._loop_timeline.restart();
            ...
            if (e.hasClass("rs-pulse") && null == i._loop_timeline) {
                ...
                (r = null == e.data("speed") ? 2 : e.data("speed")), (s = null == e.data("easing") ? punchgs.Power2.easeInOut : e.data("easing"));
                i._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", scale: p }, { scale: g, ease: s })),
                    i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
                            e,
                            r, { force3D: "auto", scale: g }, {
                                scale: p,
                                onComplete: function() {
                                    i._loop_timeline.restart();
                                },
