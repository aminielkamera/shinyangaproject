                ...
                a.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function() {
                    ...
                    if (!0 === j.enable) {
                        ...
                        jQuery.each(f.thumbs[i].params, function(a, b) {
                            ...
                            j.right.j.html(k),
                            j.rtl ?
                            (punchgs.TweenLite.set(j.left.j.find(".tp-arr-imgholder"), { backgroundImage: "url(" + f.thumbs[i].src + ")" }),
                                punchgs.TweenLite.set(j.right.j.find(".tp-arr-imgholder"), { backgroundImage: "url(" + f.thumbs[h].src + ")" })) :
    ...
    var e = function(a, b) {
        ...
        g = function(a) {
            ...
            return (
                ...
                (e > 300 || e < -300) && (e /= 10), { spinX: b, spinY: c, pixelX: d, pixelY: e }
            );
        },
        h = function(a, c) {
            "on" === c.navigation.keyboardNavigation &&
                jQuery(document).keydown(function(d) {
                    (("horizontal" == c.navigation.keyboard_direction && 39 == d.keyCode) || ("vertical" == c.navigation.keyboard_direction && 40 == d.keyCode)) &&
                    ((c.sc_indicator = "arrow"), (c.sc_indicator_dir = 0), b.callingNewSlide(a, 1)),
                    (("horizontal" == c.navigation.keyboard_direction && 37 == d.keyCode) || ("vertical" == c.navigation.keyboard_direction && 38 == d.keyCode)) &&
                    ((c.sc_indicator = "arrow"), (c.sc_indicator_dir = 1), b.callingNewSlide(a, -1));
                });
        },
        i = function(a, c) {
            if ("on" === c.navigation.mouseScrollNavigation || "carousel" === c.navigation.mouseScrollNavigation) {
                ...
                a.on("mousewheel DOMMouseScroll", function(f) {
                    var h = g(f.originalEvent),
                        ...
                        m = !0;
                    "carousel" == c.navigation.mouseScrollNavigation && (k = l = !1), -1 == j ?
                        h.pixelY < d ?
        ...
        j = function(a, b, d) {
            return (
                (a = c ? jQuery(d.target).closest("." + a).length || jQuery(d.srcElement).closest("." + a).length : jQuery(d.toElement).closest("." + a).length || jQuery(d.originalTarget).closest("." + a).length), !0 === a || 1 === a ? 1 : 0
            );
        },
        k = function(a, d, e) {
            var f = d.carousel;
                ...
                h.swipetp({
                    ...
                    swipeStatus: function(e, g, h, i, l, m, n) {
                        ...
                        if (
                            ...
                            ((("move" === g || "end" === g || "cancel" == g) && d.dragStartedOverSlider && !d.dragStartedOverThumbs && !d.dragStartedOverTabs) || ("start" === g && o > 0 && 0 === p && 0 === q))
                        ) {
                            ...
                            switch (((d.dragStartedOverSlider = !0), (i = h && h.match(/left|up/g) ? Math.round(-1 * i) : (i = Math.round(1 * i))), g)) {
                                ...
                                case "move":
                                    if (
                                        (d.c.find(".tp-withaction").addClass("tp-temporarydisabled"), (f.slide_offset = "off" === f.infinity ? f.slide_globaloffset + i : b.simp(f.slide_globaloffset + i, f.maxwidth)), "off" === f.infinity)
                                    ) {
                                        ...
                                        ("none" !== f.overpull && 0 !== f.overpull) || !(t < 0 || t > d.slideamount - 1) ?
                                        t >= 0 && t <= d.slideamount - 1 && ((t >= 0 && i > f.overpull) || (t <= d.slideamount - 1 && i < f.overpull)) && (f.overpull = 0): (f.overpull = i),
                                            (f.slide_offset =
                                                t < 0 ?
                                                f.slide_offset + (f.overpull - i) / 1.1 + Math.sqrt(Math.abs((f.overpull - i) / 1.1)) :
                                                t > d.slideamount - 1 ?
                                                f.slide_offset + (f.overpull - i) / 1.1 - Math.sqrt(Math.abs((f.overpull - i) / 1.1)) :
                                                f.slide_offset);
                                    }
                            ...
                            switch (g) {
                                ...
                                case "move":
                                    ...
                                    "vertical" === B ? punchgs.TweenLite.set(A, { top: G + "px" }) : punchgs.TweenLite.set(A, { left: G + "px" });
                                    break;
                                case "end":
                                case "cancel":
                                    if (s)
                                        return (
                                            (G = F + i),
                                            (G = "vertical" === B ? (G < 0 - (A.height() - z.height()) ? 0 - (A.height() - z.height()) : G) : G < 0 - (A.width() - z.width()) ? 0 - (A.width() - z.width()) : G),
                                            (G = G > 0 ? 0 : G),
                                            (G = Math.abs(i) > E / 10 ? (i <= 0 ? Math.floor(G / E) * E : Math.ceil(G / E) * E) : i < 0 ? Math.ceil(G / E) * E : Math.floor(G / E) * E),
                                            (G = "vertical" === B ? (G < 0 - (A.height() - z.height()) ? 0 - (A.height() - z.height()) : G) : G < 0 - (A.width() - z.width()) ? 0 - (A.width() - z.width()) : G),
                                            (G = G > 0 ? 0 : G),
                                            "vertical" === B ? punchgs.TweenLite.to(A, 0.5, { top: G + "px", ease: punchgs.Power3.easeOut }) : punchgs.TweenLite.to(A, 0.5, { left: G + "px", ease: punchgs.Power3.easeOut }),
                                            (G = G || ("vertical" === B ? A.position().top : A.position().left)),
                                            A.data("offset", G),
                                            A.data("distance", i),
                                            setTimeout(function() {
                                                (d.dragStartedOverSlider = !1), (d.dragStartedOverThumbs = !1), (d.dragStartedOverTabs = !1);
                                            }, 100),
                                            a.parent().find(u).removeClass("dragged"), !1
                                        );
                            }
                        }
                    },
        ...
        r = function(a, b, c) {
            var d = a.outerHeight(!0),
                ...
                0,
                h =
                "top" === b.v_align ? { top: "0px", y: Math.round(b.v_offset + g) + "px" } :
                "center" === b.v_align ? { top: "50%", y: Math.round(0 - d / 2 + b.v_offset) + "px" } : { top: "100%", y: Math.round(0 - (d + b.v_offset + g)) + "px" };
        ...
        s = function(a, b, c) {
            var e = (a.outerHeight(!0), a.outerWidth(!0)),
                ...
                g =
                "left" === b.h_align ? { left: "0px", x: Math.round(b.h_offset + f) + "px" } :
                "center" === b.h_align ? { left: "50%", x: Math.round(0 - e / 2 + b.h_offset) + "px" } : { left: "100%", x: Math.round(0 - (e + b.h_offset + f)) + "px" };
        ...
        t = function(a, b, c) {
            ...
            if (
                ...
                h > e && "outer-left" !== b.position && "outer-right" !== b.position ?
                    ...
                    "outer-left" !== b.position && "outer-right" !== b.position && ((k = 0), (l = 0)), !0 === b.span && "vertical" === b.direction ?
                    (punchgs.TweenLite.set(a, { maxHeight: k + l + (f - 2 * g) + "px", height: k + l + (f - 2 * g) + "px", top: 0 - k, y: 0 }), r(j, b, c)) :
                    !0 === b.span && "horizontal" === b.direction && (punchgs.TweenLite.set(a, { maxWidth: "100%", width: e - 2 * g + "px", left: 0, x: 0 }), s(j, b, c));
            }
        },
        u = function(a, b, c, d) {
        ...
        w = function(a, b, c, d, e) {
            ...
            u.find(j).css({ backgroundImage: "url(" + e.thumbs[c.index()].src + ")" }),
                "vertical" === b.direction ?
                (u.css({ top: (v - 1) * x + "px", left: "0px" }), p.css({ height: (v - 1) * x + u.outerHeight(), width: u.outerWidth() })) :
                (u.css({ left: (v - 1) * w + "px", top: "0px" }), p.css({ width: (v - 1) * w + u.outerWidth(), height: u.outerHeight() })),
                n.data("maxw", q),
                n.data("maxh", r),
            ...
            o.css({ maxWidth: q + "px", maxHeight: r + "px", overflow: "hidden", position: "relative" }),
                n.css({ maxWidth: q + "px", maxHeight: r + "px", overflow: "visible", position: y, background: b.wrapper_color, padding: b.wrapper_padding + "px", boxSizing: "contet-box" }),
                u.click(function() {
