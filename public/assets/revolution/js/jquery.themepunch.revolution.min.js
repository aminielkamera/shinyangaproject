    ...
    var _ISM = _R.is_mobile(),
            ...
            return (!jQuery("body").data(i) &&
                (t.filesystem ?
                    (t.errorm === undefined && (t.errorm = "<br>Local Filesystem Detected !<br>Put this to your header:"),
                        ...
                        console.log(" "), !(t.modulesfailing = !0)) :
                    (jQuery.ajax({
        ...
        runSlider = function(t, x) {
            ...
            if (
                (x.shadow !== undefined &&
                    ...
                    setCurWinRange(x),
                    setCurWinRange(x, !0), !t.hasClass("revslider-initialised"))
            ) {
                        ...
                        if ((e.attr("src", t.src), "img" == t.type))
                            if (e.hasClass("defaultimg"))
                                ...
                                e.data("owidth", t.width),
                                    ...
                                    (n = n == undefined || "auto" == n || "" == n ? t.height : n), !jQuery.isNumeric(a) && 0 < a.indexOf("%") && (n = a),
                                    e.data("ww", a),
                                    e.data("hh", n);
                            }
        ...
        swapSlide = function(e) {
            ...
            !0 === i.onlyPreparedSlide && ((i.onlyPreparedSlide = !1), jQuery(i.li[0]).addClass("processing-revslide")),
                a.removeClass("next-revslide").addClass("processing-revslide"), -1 === a.index() && "carousel" === i.sliderType && (a = jQuery(i.li[0])),
